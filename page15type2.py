...
if __name__ == "__main__":
    ...
    for pdf_path in ['DOES NOT SCAN 2.pdf']:
        ...
        if filled_radio_buttons :
            output_image, roi_coordinates = extract_text_roi(output_image, filled_radio_buttons,x_radio_ratio,y_radio_ratio)
        ...
        if len(table_circles)>25:
            ...
            output_image, table_squars = detect_checkboxes2(thresh_radio,output_image)
            table_filled_buttons,output_image = detect_filled_button(thresh_check,table_squars,output_image,filled_radio_ratio)
            if table_filled_buttons:
